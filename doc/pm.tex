...
create_assign(G, X, Y) ->
  ...
  case digraph:add_edge(G, Vx, Vy, Y) of
	...
	\emph{TBD: Make the error handling more consistent. Errors in the interface will cause exceptions to be raised but failures in the underlying administrative commands are returned as a tuple \lstinline|\{error, Reason\}|. Either always return \lstinline|\{error, Reason\}| or throw an exception.}
